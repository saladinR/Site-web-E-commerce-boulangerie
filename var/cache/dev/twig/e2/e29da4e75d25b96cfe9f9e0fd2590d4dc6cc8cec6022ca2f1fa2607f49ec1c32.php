...
class __TwigTemplate_feb28dedb140e583a3f1e6a7f3693127534aadc2c4a4a38a9792bd376d31bc09 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"section\">
    <div class=\"container\">
        ...
        if ( !(null === (isset($context["carrier"]) || array_key_exists("carrier", $context) ? $context["carrier"] : (function () { throw new RuntimeError('Variable "carrier" does not exist.', 102, $this->source); })()))) {
            // line 103
            echo "                    <a class=\"btn btn-fill-out btn-block\" id=\"checkout-button-payement\">payment :
                        ";
            // line 104
        ...
        <div class=\"col-md-12\">
            <div class=\"order_review \">
                ...
                <div class=\"payment_method\">
                    ...
                    {% if carrier is not null%}
                    <a class=\"btn btn-fill-out btn-block\" id=\"checkout-button-payement\">payment :
...
{% endblock %}
", "checkout/confirm.html.twig", "/Applications/MAMP/htdocs/symfony boulangerie/Eco-ble/templates/checkout/confirm.html.twig");
    }
}
