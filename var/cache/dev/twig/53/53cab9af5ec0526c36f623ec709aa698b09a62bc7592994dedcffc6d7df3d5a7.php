...
class __TwigTemplate_d8e3c3ec90eb0348f923966e991c529342940c100a3eb3724c4b9754f529388f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    ";
        echo twig_include($this->env, $context, "partials/Title.html.twig", ["name" => "register"]);
        echo "
    ...
    <div class=\"container\">
        ...
        echo "
                            ...
                            <div class=\"form-row\">
                                 <div class=\"col-md-6\">";
        // line 28
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 28, $this->source); })()), "firstname", [], "any", false, false, false, 28), 'row');
        echo "</div>
                                 <div class=\"col-md-6\">";
        // line 29
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 29, $this->source); })()), "lastname", [], "any", false, false, false, 29), 'row');
        echo "</div>
        ...
        echo "\" target=\"_blank\">Lire les conditions</a>
                            </div>
                            <div class=\"form-group\">
...
";
    ...
    {
        return array (  180 => 55,  169 => 47,  161 => 42,  156 => 40,  149 => 36,  143 => 33,  136 => 29,  132 => 28,  126 => 25,  121 => 23,  117 => 21,  108 => 19,  104 => 18,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    {{ include(\"partials/Title.html.twig\",{'name':'register'}) }}
            ...
            \t\t<div class=\"padding_eight_all bg-white\">
                        ...
                        {{ form_start(registrationForm) }}
                            ...
                            <div class=\"login_footer form-group\">
                              ...
                              <br><a href=\"{{path('cgu_conditions')}}\" target=\"_blank\">Lire les conditions</a>
                            </div>
                            <div class=\"form-group\">
                                <button type=\"submit\" class=\"btn btn-fill-out btn-block\" name=\"register\">Register</button>
                            </div>
...
{% endblock %}
", "registration/register.html.twig", "C:\\wamp64\\www\\Eco-ble\\templates\\registration\\register.html.twig");
    }
}
