 ...
 */
class getSycommerceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SycommerceRepository' shared autowired service.
     *
     * @return \App\Repository\SycommerceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SycommerceRepository.php';

        return $container->privates['App\\Repository\\SycommerceRepository'] = new \App\Repository\SycommerceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
